    ...
    <div className="w-10/12 mx-auto py-10">
      <div className="flex flex-col md:flex-row items-center justify-between gap-5 mb-10">
        <div>
          ...
          <p className="text-gray-500 mt-1">Find your favorite doctor easily</p>
        </div>
        ...
        <div className="relative w-full md:w-[350px]">
          ...
          <input
            ...
            className="w-full pl-12 pr-5 py-3 rounded-2xl border border-gray-200 outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
          />
        </div>
      </div>
